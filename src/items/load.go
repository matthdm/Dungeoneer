...
func registerNewArtifacts() {
	...
	RegisterItem(&ItemTemplate{
		...
		Name:           "Ashbound Chain",
		Type:           ItemWeapon,
		Description:    "Bind your target in place for 2 seconds. +4 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
	...
	RegisterItem(&ItemTemplate{
		...
		Name:           "Grave Reaper",
		Type:           ItemWeapon,
		Description:    "Execute an enemy below 20% HP. Elite. +6 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
	...
	RegisterItem(&ItemTemplate{
		...
		Type:           ItemWeapon,
		Description:    "Tear open a collapsing rift at your target: deal damage and root them for 1.5s. +6 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
		Stats:          map[string]int{"MaxMana": 6},
	...
	RegisterItem(&ItemTemplate{
		...
		Type:           ItemArmor,
		Description:    "Passive: a warping void aura extends all your skill durations by 15%. +6 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
		Stats:          map[string]int{"MaxMana": 6},
	...
	RegisterItem(&ItemTemplate{
		...
		Type:           ItemArmor,
		Description:    "Passive: all skill durations increased by 20%. +6 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
	...
	RegisterItem(&ItemTemplate{
		...
		Name:           "Arcane Surge",
		Type:           ItemWeapon,
		Description:    "Active: deal 12 × (artifacts on cooldown) arcane damage to nearby enemies. Elite. +10 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
	...
	RegisterItem(&ItemTemplate{
		...
		Name:           "Blood Price",
		Type:           ItemWeapon,
		Description:    "Active: sacrifice 25% of your current HP to deal 200 void damage. +6 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
		Stats:          map[string]int{"MaxMana": 6},
	...
	RegisterItem(&ItemTemplate{
		...
		Name:           "Soul Harvest",
		Type:           ItemWeapon,
		Description:    "Passive: each kill restores 20% of your maximum HP. +8 Intelligence.",
		Stackable:      false,
		MaxStack:       1,
		Equippable:     true,
	...
	RegisterItem(&ItemTemplate{
		...
		Type:        ItemArmor,
		Description: "+8 Intelligence. All active skill cooldowns reduced by 10%.",
		Stackable:   false,
		MaxStack:    1,
		Equippable:  true,
	...
	RegisterItem(&ItemTemplate{
		...
		Name:        "Hollow Sigil",
		Type:        ItemMisc,
		Description: "+6 Intelligence. Void skill costs are paid with HP instead of mana.",
		Stackable:   false,
		MaxStack:    1,
		Equippable:  true,
		Stats:       map[string]int{"MaxMana": 6},
